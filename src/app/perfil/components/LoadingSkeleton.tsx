...
{/* ── Skeleton de la Galería (Instagram Style) ── */}
<div style={{ 
display:'grid', 
gridTemplateColumns:'repeat(3, 1fr)', 
gap:'4px' // Gap pequeño igual que en el WorksGrid
}}>
...
className="sk" 
style={{ 
aspectRatio:'1/1', // Cuadros perfectos
borderRadius: 4 // Un poco de redondeo para que se vea moderno
}}
/>
))}
</div>
