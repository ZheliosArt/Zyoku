...
{/* Fila del Avatar y Botones - Se desplaza sola porque el banner creció */}
<div style={{
display:'flex', justifyContent:'space-between', alignItems:'flex-end',
flexWrap:'wrap', gap:12, marginTop:-50, marginBottom:18, padding: '0 16px'
}}>
{/* Avatar - Lo hice un poquito más grande para que no se vea pequeño con el nuevo banner */}
<div
...
<img
src={avatarUrl}
style={{ width:170, height:170, borderRadius:'50%', border:'4px solid #0a1628', boxShadow:'0 0 0 2px #00cfff33', objectFit:'cover', display:'block' }}
/>
...
{/* Action buttons - Estos botones bajarán automáticamente al crecer el banner */}
...
style={{ padding:'8px 16px', fontSize:13, color:'#ff6b9dcc', borderColor:'#2a1020' }}>
Salir
</button>
</>
)}
